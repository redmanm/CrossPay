      ...
      <div className="w-full max-w-md">
        ...
        <div className="mb-12">
          ...
          <div className="space-y-2">
            ...
            <p className="text-lg text-foreground/60">Sign in to your account to continue sending money</p>
          </div>
        </div>
        ...
        <div className="space-y-4">
          ...
          <Button
            variant="link"
            className="w-full text-foreground/60 hover:text-foreground transition-colors duration-200"
          >
            Forgot password?
          </Button>
        </div>
