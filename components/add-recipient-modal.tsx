...
import { createRecipient } from "@/lib/api-client"
...
export function AddRecipientModal({ open, onOpenChange, onSuccess }: AddRecipientModalProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setLoading(true)
    try {
      const recipient = await createRecipient(formData)
      toast({
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-md">
        <DialogHeader>
          ...
          <DialogDescription>Add a new recipient to send money to</DialogDescription>
        </DialogHeader>
